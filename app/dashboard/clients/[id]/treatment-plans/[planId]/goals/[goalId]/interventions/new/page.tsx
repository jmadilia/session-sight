...
import { NewInterventionForm } from "@/components/new-intervention-form";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Add Intervention</h1>
      ...
      <NewInterventionForm clientId={id} planId={planId} goalId={goalId} />
    </div>
  );
}
